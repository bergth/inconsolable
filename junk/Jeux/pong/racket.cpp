...
void Racket::update()
{
	...
	if ((Ball::get_coord_x() - Ball::get_center_x() <= this->coord_x + this->center_x) && (Ball::get_coord_x() + Ball::get_center_x() >= this->coord_x - this->center_x) && (Ball::get_coord_y() - Ball::get_center_y() <= this->coord_y + this->center_y) && (Ball::get_coord_y() + Ball::get_center_y() >= this->coord_y - this->center_y)) {

		Ball::inverse_dir_x();
		Ball::set_coef_dir( (this->coord_x - Ball::get_coord_x()) * 3 / (this->center_y + Ball::get_center_y()) );
	}
}
